...
author: "David Henderson, Tim Churches"
date: "2018-08-30"
...
```{r save, eval=FALSE}
clean_data <- raw_data
write_feather(clean_data, path=here("assets/clean_data.feather"))
rm(raw_data)
```
...
```{r plot_shape, fig.width=9, fig.height=6, eval=TRUE}
shapefile %>% 
  ggplot() +
  geom_sf() +
