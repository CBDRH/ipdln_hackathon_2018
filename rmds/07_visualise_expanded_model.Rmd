...
orplot(expglm_df, slice_range=2:15, ref_level="19-24") +
...
orplot(expglm_df, slice_range=59:67, ref_level="Decile 10 - highest") +
...
orplot(expglm_df, slice_range=69:80, ref_level="Ontario", sorted=TRUE) +
  scale_y_discrete(labels = rev(y_labels))
```
